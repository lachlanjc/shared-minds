...
export async function POST(req: Request) {
  ...
  const response = await replicate.predictions.create({
    ...
    input: {
      prompt: `Make a list of spelling and grammar errors in the following text. Do not re-list anything without errors. Respond with ONLY the list and corrected sentence.
